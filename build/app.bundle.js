...
var _GitHub = __webpack_require__(331);
...
document.querySelector('#input').addEventListener('keyup', function (e) {
  ...
  // Get user API
  userApi = _GitHub.github.getUser(UserInput);
...
var GitHub = function () {
  ...
  _createClass(GitHub, [{
    ...
    value: function getUser(user) {
      var profile = _http.http.get('https://api.github.com/users/' + user + '?client_id="' + this.clientId + '"&client_secret="' + this.clientSecret + '"');
...
var github = exports.github = new UI();
